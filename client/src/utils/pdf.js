...
const buildInvoiceHTML = (invoice) => {
  ...
  return `
    ...
    ">
      <div style="border: 1px solid #2f2f2f; padding: 14px 14px; box-sizing: border-box; min-height: 240mm; display: flex; flex-direction: column;">
        <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 16px;">
          <div style="display: flex; align-items: flex-start; gap: 12px; flex: 1;">
            <div style="width: 64px; height: 64px; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0;">
            ...
            <div style="text-align: left;">
              <div style="font-size: 20px; font-weight: 600; line-height: 1.12;">${COMPANY.nameLine1}</div>
              <div style="font-size: 20px; font-weight: 600; line-height: 1.12; margin-bottom: 4px;">${COMPANY.nameLine2}</div>
              <div style="font-size: 12px; font-weight: 500;">${COMPANY.address1}</div>
              <div style="font-size: 12px; font-weight: 500;">${COMPANY.address2}</div>
              <div style="font-size: 12px; font-weight: 500;">${COMPANY.address3}</div>
              <div style="font-size: 13px; font-weight: 600; margin-top: 2px;">${COMPANY.gst}</div>
            </div>
          </div>

          <div style="min-width: 220px; font-size: 12px; margin-top: 6px; line-height: 1.55;">
        ...
        <div style="display: flex; justify-content: space-between; gap: 14px; margin-top: 18px;">
          <div style="flex: 1; border: 1px solid #8f8f8f; padding: 10px 12px; font-size: 12px;">
            <div style="font-weight: 500; margin-bottom: 6px;">Bill To: ${factoryName}</div>
            <div style="display:flex; gap:6px;"><span style="font-weight:600; width:54px;">Address:</span><span style="font-weight:500;">${customerAddress}</span></div>
            <div style="display:flex; gap:6px;"><span style="font-weight:600; width:54px;">GSTIN:</span><span style="font-weight:600;">${customerGst}</span></div>
          </div>

          <div style="width: 250px; background: #f3f3f3; border: 1px solid #b3b3b3; padding: 8px 10px; font-size: 12px; line-height: 1.6;">
        ...
        <div style="text-align: center; margin: 22px 0 12px;">
          <span style="font-size: 14px; font-weight: 600; color: #7B4F2C; border-bottom: 2px solid #7B4F2C; padding: 0 10px 4px;">SUPPLY DETAILS</span>
        </div>

        <table style="width:100%; border-collapse: collapse; font-size:12px;">
          <thead>
            <tr style="background:#f0f0f0;">
              <th style="border:1px solid #000; padding:8px 6px; font-weight:600;">S.No</th>
              <th style="border:1px solid #000; padding:8px 6px; font-weight:600;">Description</th>
              <th style="border:1px solid #000; padding:8px 6px; font-weight:600;">Gross (Kg)</th>
              <th style="border:1px solid #000; padding:8px 6px; font-weight:600;">Tare (Kg)</th>
              <th style="border:1px solid #000; padding:8px 6px; font-weight:600;">Net (Kg)</th>
              <th style="border:1px solid #000; padding:8px 6px; font-weight:600;">Rate / Ton</th>
              <th style="border:1px solid #000; padding:8px 6px; font-weight:600;">Amount (INR)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td style="border:1px solid #000; padding:9px 6px; text-align:center;">1</td>
              <td style="border:1px solid #000; padding:9px 6px;">Firewood Load</td>
              <td style="border:1px solid #000; padding:9px 6px; text-align:right;">${qty(invoice.grossWeight)}</td>
              <td style="border:1px solid #000; padding:9px 6px; text-align:right;">${qty(invoice.tareWeight)}</td>
              <td style="border:1px solid #000; padding:9px 6px; text-align:right;">${qty(invoice.netWeight)}</td>
              <td style="border:1px solid #000; padding:9px 6px; text-align:right; font-weight:600;">${rateValue(invoice.ratePerTon)}</td>
              <td style="border:1px solid #000; padding:9px 6px; text-align:right; font-weight:600;">${money(invoice.totalAmount)}</td>
            </tr>
          </tbody>
          <tfoot>
            <tr>
              <td colspan="6" style="border:1px solid #000; padding:9px 6px; text-align:right; font-weight:600;">Grand Total</td>
              <td style="border:1px solid #000; padding:9px 6px; text-align:right; font-weight:600;">INR ${money(invoice.totalAmount)}</td>
            </tr>
          </tfoot>
        </table>

        <div style="display:flex; align-items:stretch; justify-content:space-between; gap:10px; margin-top:18px;">
          <div style="flex:1; border:1px solid #a8a8a8; padding:9px 10px; font-size:12px; font-weight:500;">
            <strong>Amount in Words:</strong> ${amountWords}
          </div>
          <div style="width:180px; border:2px solid #7B4F2C; padding:8px 10px; text-align:right; font-size:16px; font-weight:600; display:flex; align-items:center; justify-content:flex-end;">
            INR ${money(invoice.totalAmount)}
          </div>
        </div>

        <div style="border:1px solid #b7b7b7; margin-top:18px; padding:11px 12px; font-size:12px;">
          <div style="font-size:14px; font-weight:600; color:#7B4F2C; border-bottom:1px solid #7B4F2C; display:inline-block; margin-bottom:8px;">Bank Details</div>
        ...
        <div style="display:flex; justify-content:space-between; gap:12px; margin-top:auto; border-top:1px solid #c0c0c0; padding-top:12px; font-size:11px;">
          <div style="flex:1;">
          ...
          <div style="width:260px; text-align:center; border-left:1px solid #c0c0c0; padding-left:12px;">
            ...
            <div style="height:48px; display:flex; align-items:flex-end; justify-content:center;">
              <img src="/signature.png" alt="signature" style="max-height:42px; max-width:160px; object-fit:contain;" onerror="this.style.display='none';" />
            </div>
